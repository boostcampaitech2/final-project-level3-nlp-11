...
def TrainRetrievalDataset(tokenizer_name: str="monologg/kobigbird-bert-base", dataset_name: str) -> TensorDataset:
    print("get in-batch training sample")
...
class TrainRetrievalNegativeDataset(torch.utils.data.Dataset):
    def __init__(
